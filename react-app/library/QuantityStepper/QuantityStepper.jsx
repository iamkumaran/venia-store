...
const QuantityStepper = ({ classes = '', setQty, selectedQty = 1 }) => {
  const [counter, setCounter] = useState(selectedQty);
  ...
  return (
    <div
      className={`${classes} quantityStepper-root-39j gap-x-2xs grid items-center justify-items-center text-center justify-start`}>
